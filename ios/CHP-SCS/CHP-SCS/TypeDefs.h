...
#ifndef CHP_SCS_TypeDefs_h
#define CHP_SCS_TypeDefs_h

// font names macros
#define LIGHT_FONT_NAME @"SWZ721L"
#define MEDIUM_FONT_NAME @"SWZ721M"
#define THIN_FONT_NAME @"SWZ721T"
...
#define TOP_BAR_TEXT_FONT [UIFont fontWithName:@"SWZ721M" size:22.0]
